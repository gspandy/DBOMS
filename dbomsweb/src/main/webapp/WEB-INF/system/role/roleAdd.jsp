                	...
                	<form>
                       <div class="form-group">
                           <label class="form-label" for="">角色编码：</label>
                            <input id="roleCode" name="roleCode" maxlength="32" type="text" class="input-text" value="" onblur="jiaoyanCode();">
                       </div>
                       <%--
                       <div class="form-group">
                       ...
                       <div class="form-group">
                           ...
                           <input id="roleName" name="roleName" maxlength="100" type="text" class="input-text" value="" onblur="jiaoyanName();">
                       </div>
                     <div class="form-group">
                           <label class="form-label" for="">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</label>
                           <textarea class="textarea" name="roleDesc" maxlength="500" id="roleDesc" cols="30" rows="5"></textarea>
                       </div>
                       <div class="form-group">
