							...
							'<td colspan="2">' +
								'<div class="ui_title_bar">' +
									...
									'<div class="ui_title_buttons">' +
										'<a class="ui_min" href="javascript:void(0);" title="Min"><b class="ui_min_b"></b></a>' +
										'<a class="ui_max" href="javascript:void(0);" title="Max"><b class="ui_max_b"></b></a>' +
										'<a class="ui_res" href="javascript:void(0);" title="Recovery"><b class="ui_res_b"></b><b class="ui_res_t"></b></a>' +
...
lhgdialog.setting =
{
    content: '<div class="ui_loading"><span>加载...</span></div>',
	title: '窗口',     // 标题,默认'视窗'
	button: null,	     		// 自定义按钮
	ok: null,					// 确定按钮回调函数
