...
bb.num=$("<input class=\"pagination-num\" type=\"text\" value=\"1\" size=\"2\" style=\"width:50px;\">").appendTo(tr).wrap("<td></td>");
...
},beforePageText:"页码",afterPageText:" {pages}",displayMsg:"显示 {from} 从 {to} 总共 {total} 条数据",nav:{first:{iconCls:"pagination-first",handler:function(){
