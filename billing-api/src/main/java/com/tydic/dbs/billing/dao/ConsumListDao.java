/**
 * com.sunrise.accout.dao.ConsumListDao.java
 */
 ...
 *   	2. ...
 */
public class ConsumListDao extends BaseDao {	
    /**
     * 分页查询
	...
	public Page queryForPage(Map params) throws Exception {
		return queryForPage("CONSUM_LIST.selectByParams", params, null);
	}
	...
	public List selectAll() throws Exception {
		return queryForList("CONSUM_LIST.selectAll", null);
	}
	...
	public List selectByParamMap(Map paramMap) throws Exception {
	    return queryForList("CONSUM_LIST.selectByParams", paramMap);
	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List selectByVo(ConsumList vo) throws Exception {
	    if(vo == null) return null;
	    return queryForList("CONSUM_LIST.selectByVO", vo);
	}
	 ...
	 * @throws Exception
     */
	public ConsumList selectByPk(String pkId) throws Exception {
    	if(StringUtils.isEmpty(pkId)) return null;
    	return (ConsumList)queryForObject("CONSUM_LIST.selectByPk", pkId);
    }
	 ...
	 * @throws Exception
	 */
	public ConsumList insertByVo(ConsumList vo) throws Exception {
	    if(vo == null) return null;
	    return (ConsumList)insert("CONSUM_LIST.insertByVo", vo);
    }
	 ...
	 * @throws Exception
	 */
	public ConsumList updateByVo(ConsumList vo) throws Exception {
		if(vo == null) return null;
		update("CONSUM_LIST.updateByVO", vo);
		return vo;
	}
	 ...
	 * @throws Exception
	 */
	public ConsumList updateByVoNotNull(ConsumList vo) throws Exception {
		if(vo == null) return null;
		update("CONSUM_LIST.updateByVoNotNull", vo);
		return vo;
	}
    ...
    public boolean updateStatus(Map params) throws Exception {
    	...
    	getSqlSession().update("CONSUM_LIST.updateStatus", params);
    	return true;
    }
	...
	public boolean deleteAll() throws Exception {
		return delete("CONSUM_LIST.deleteAll", null) > 0?true:false;
	}
	 ...
	 * @throws Exception
	 */
	public boolean deleteByVo(ConsumList vo) throws Exception {
		if(vo == null) return false;
		int i = delete("CONSUM_LIST.deleteByVO", vo);
    ...
    public boolean deleteByPk(String pkId) throws Exception {
		...
		delete("CONSUM_LIST.deleteByPk", pkId);
		return true;
	}
}
