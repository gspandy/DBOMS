/**
 * com.sunrise.ord.dao.OrdRusultDao.java
 */
...
/**
 * 
 * @ClassName: OrdRusultDao 
 * @Description: TODO(工单结果DAO) 
 * @author huangChuQin
 * @date 2016-8-5 下午4:56:13 
 *
 */
public class OrdRusultDao extends BaseDao {	
    /**
     * 分页查询
	...
	public Page queryForPage(Map params) throws Exception {
		return queryForPage("ORD_RUSULT.selectByParams", params, null);
	}
	...
	public List selectAll() throws Exception {
		return queryForList("ORD_RUSULT.selectAll", null);
	}
	...
	public List selectByParamMap(Map paramMap) throws Exception {
	    return queryForList("ORD_RUSULT.selectByParams", paramMap);
	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List selectByVo(OrdRusult vo) throws Exception {
	    if(vo == null) return null;
	    return queryForList("ORD_RUSULT.selectByVO", vo);
	}
	 ...
	 * @throws Exception
     */
	public OrdRusult selectByPk(String pkId) throws Exception {
    	if(StringUtils.isEmpty(pkId)) return null;
    	return (OrdRusult)queryForObject("ORD_RUSULT.selectByPk", pkId);
    }
	 ...
	 * @throws Exception
	 */
	public OrdRusult insertByVo(OrdRusult vo) throws Exception {
	    if(vo == null) return null;
	    return (OrdRusult)insert("ORD_RUSULT.insertByVo", vo);
    }
	 ...
	 * @throws Exception
	 */
	public OrdRusult updateByVo(OrdRusult vo) throws Exception {
		if(vo == null) return null;
		update("ORD_RUSULT.updateByVO", vo);
		return vo;
	}
	 ...
	 * @throws Exception
	 */
	public OrdRusult updateByVoNotNull(OrdRusult vo) throws Exception {
		if(vo == null) return null;
		update("ORD_RUSULT.updateByVoNotNull", vo);
		return vo;
	}
    ...
    public boolean updateStatus(Map params) throws Exception {
    	...
    	getSqlSession().update("ORD_RUSULT.updateStatus", params);
    	return true;
    }
	...
	public boolean deleteAll() throws Exception {
		return delete("ORD_RUSULT.deleteAll", null) > 0?true:false;
	}
	 ...
	 * @throws Exception
	 */
	public boolean deleteByVo(OrdRusult vo) throws Exception {
		if(vo == null) return false;
		int i = delete("ORD_RUSULT.deleteByVO", vo);
    ...
    public boolean deleteByPk(String pkId) throws Exception {
		...
		delete("ORD_RUSULT.deleteByPk", pkId);
		return true;
	}
}
