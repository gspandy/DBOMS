/**
 * com.tydic.dbs.system.operator.service.SysChanOperRelService.java
 */
...
/**
 * @file  SysChanOperRelService.java
 * @author liugaolin
 * @version 0.1
 * @SysChanOperRel业务操作接口
 ...
 *   	2. ...
 */
public abstract interface SysChanOperRelService {
     ...
     * @throws Exception
     */
    public abstract List<SysChanOperRel> getChanOperRelByOperId(String operId) throws Exception;
