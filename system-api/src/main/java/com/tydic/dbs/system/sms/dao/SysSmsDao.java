package com.tydic.dbs.system.sms.dao;
 ...
 *   	2. ...
 */
public class SysSmsDao extends BaseDao {	
    /**
     * 分页查询
	...
	public Page queryForPage(Map params) throws Exception {
		return queryForPage("SYS_SMS.selectByParams", params, null);
	}
	...
	public List selectAll() throws Exception {
		return queryForList("SYS_SMS.selectAll", null);
	}
	...
	public List selectByParamMap(Map paramMap) throws Exception {
	    return queryForList("SYS_SMS.selectByParams", paramMap);
	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List selectByVo(SysSms vo) throws Exception {
	    if(vo == null) return null;
	    return queryForList("SYS_SMS.selectByVO", vo);
	}
	 ...
	 * @throws Exception
     */
	public SysSms selectByPk(Long pkId) throws Exception {
    	if(pkId ==null) return null;
    	return (SysSms)queryForObject("SYS_SMS.selectByPk", pkId);
    }
	 ...
	 * @throws Exception
	 */
	public SysSms insertByVo(SysSms vo) throws Exception {
	    if(vo == null) return null;
	    return (SysSms)insert("SYS_SMS.insertByVo", vo);
    }
	 ...
	 * @throws Exception
	 */
	public SysSms updateByVo(SysSms vo) throws Exception {
		if(vo == null) return null;
		update("SYS_SMS.updateByVO", vo);
		return vo;
	}
	 ...
	 * @throws Exception
	 */
	public SysSms updateByVoNotNull(SysSms vo) throws Exception {
		if(vo == null) return null;
		update("SYS_SMS.updateByVoNotNull", vo);
		return vo;
	}
    ...
    public boolean updateStatus(Map params) throws Exception {
    	...
    	getSqlSession().update("SYS_SMS.updateStatus", params);
    	return true;
    }
	...
	public boolean deleteAll() throws Exception {
		return delete("SYS_SMS.deleteAll", null) > 0?true:false;
	}
	 ...
	 * @throws Exception
	 */
	public boolean deleteByVo(SysSms vo) throws Exception {
		if(vo == null) return false;
		int i = delete("SYS_SMS.deleteByVO", vo);
    ...
    public boolean deleteByPk(Long pkId) throws Exception {
		...
		delete("SYS_SMS.deleteByPk", pkId);
		return true;
	}
}
