/**
 * com.sunrise.ord.bo.OrdLogBo.java
 */
 ...
 *   	2. ...
 */
public class OrdLogBo implements OrdLogService {
	
	private OrdLogDao ordLogDao;
	

    /**
	 * @param ordLogDao the ordLogDao to set
	 */
     ...
     */
	@SuppressWarnings({ "rawtypes" })
    public List get(OrdLog vo) throws Exception{
		if(vo == null) return null;
        return ordLogDao.selectByVo(vo);
	}
    ...
    public Page getPageByParamMap(Map params) throws Exception{
		...
		return ordLogDao.queryForPage(params);
	}
     ...
     * @throws Exception
     */
	public OrdLog get(String pkId) throws Exception{
		if(StringUtils.isEmpty(pkId)) return null;
     	return ordLogDao.selectByPk(pkId);
	}
     ...
     * @throws Exception
     */
    public OrdLog save(OrdLog vo) throws Exception{
    	if(vo == null) return null;		
		if(vo.getOrdLogId()!=null) {
			return ordLogDao.updateByVo(vo);
		} else {
			vo.setOrdLogId(OrderUtils.generateOutTradeNo());
			return ordLogDao.insertByVo(vo);
		}
    }
    ...
    public boolean delete(String pkId) throws Exception{
    	...
    	return ordLogDao.deleteByPk(pkId);
    }
	...
	public boolean deleteLogical(List ids, String modifier) throws Exception{
    	...
    	return ordLogDao.updateStatus(params);
	}
