/**
 * com.sunrise.wcs.dao.BussTenantDao.java
 */
 ...
 *   	2. ...
 */
public class BussTenantDao extends BaseDao {
    /**
     * 分页查询
	...
	public Page queryForPage(Map params) throws Exception {
		return queryForPage("BUSS_TENANT.selectByParams", params, null);
	}
	...
	public List selectAll() throws Exception {
		return queryForList("BUSS_TENANT.selectAll", null);
	}
	...
	public List selectByParamMap(Map paramMap) throws Exception {
	    return queryForList("BUSS_TENANT.selectByParams", paramMap);
	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List selectByVo(BussTenant vo) throws Exception {
	    if(vo == null) return null;
	    return queryForList("BUSS_TENANT.selectByVO", vo);
	}
	 ...
	 * @throws Exception
     */
	public BussTenant selectByPk(String pkId) throws Exception {
    	if(StringUtils.isEmpty(pkId)) return null;
    	return (BussTenant)queryForObject("BUSS_TENANT.selectByPk", pkId);
    }
	 ...
	 * @throws Exception
	 */
	public BussTenant insertByVo(BussTenant vo) throws Exception {
	    if(vo == null) return null;
	    return (BussTenant)insert("BUSS_TENANT.insertByVo", vo);
    }
	 ...
	 * @throws Exception
	 */
	public BussTenant updateByVo(BussTenant vo) throws Exception {
		if(vo == null) return null;
		update("BUSS_TENANT.updateByVO", vo);
		return vo;
	}
	 ...
	 * @throws Exception
	 */
	public BussTenant updateByVoNotNull(BussTenant vo) throws Exception {
		if(vo == null) return null;
		update("BUSS_TENANT.updateByVoNotNull", vo);
		return vo;
	}
    ...
    public boolean updateStatus(Map params) throws Exception {
    	...
    	getSqlSession().update("BUSS_TENANT.updateStatus", params);
    	return true;
    }
	...
	public boolean deleteAll() throws Exception {
		return delete("BUSS_TENANT.deleteAll", null) > 0?true:false;
	}
	 ...
	 * @throws Exception
	 */
	public boolean deleteByVo(BussTenant vo) throws Exception {
		if(vo == null) return false;
		int i = delete("BUSS_TENANT.deleteByVO", vo);
    ...
    public boolean deleteByPk(String pkId) throws Exception {
		...
		delete("BUSS_TENANT.deleteByPk", pkId);
		return true;
	}

	public  List selectBussTenant(Map map)throws  Exception{
		if (null==map) return null;
		return  queryForList("BUSS_TENANT.selectBussTenant",map);
	}

	public  List<DataPemissionDict> getDataPemissionDict()throws Exception{
		return  queryForList("BUSS_TENANT.getDataPemissionDict",null);
	}
}
