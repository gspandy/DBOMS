/**
 * com.sunrise.88.dao.InterfaceLogDao.java
 */
...
public class InterfaceLogDao extends BaseDao {
	...
	public Page queryForPage(Map params) throws Exception {
		return queryForPage("INTERFACE_LOG.selectByParams", params, null);
	}
	...
	public List selectAll() throws Exception {
		return queryForList("INTERFACE_LOG.selectAll", null);
	}
	...
	public List selectByParamMap(Map paramMap) throws Exception {
	    return queryForList("INTERFACE_LOG.selectByParams", paramMap);
	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List selectByVo(InterfaceLog vo) throws Exception {
	    if(vo == null) return null;
	    return queryForList("INTERFACE_LOG.selectByVO", vo);
	}
	 ...
	 * @throws Exception
     */
	public InterfaceLog selectByPk(String pkId) throws Exception {
    	if(StringUtils.isEmpty(pkId)) return null;
    	return (InterfaceLog)queryForObject("INTERFACE_LOG.selectByPk", pkId);
    }
	 ...
	 * @throws Exception
	 */
	public InterfaceLog insertByVo(InterfaceLog vo) throws Exception {
	    if(vo == null) return null;
	    return (InterfaceLog)insert("INTERFACE_LOG.insertByVo", vo);
    }
	 ...
	 * @throws Exception
	 */
	public InterfaceLog updateByVo(InterfaceLog vo) throws Exception {
		if(vo == null) return null;
		update("INTERFACE_LOG.updateByVO", vo);
		return vo;
	}
	 ...
	 * @throws Exception
	 */
	public InterfaceLog updateByVoNotNull(InterfaceLog vo) throws Exception {
		if(vo == null) return null;
		update("INTERFACE_LOG.updateByVoNotNull", vo);
		return vo;
	}
    ...
    public boolean updateStatus(Map params) throws Exception {
    	...
    	getSqlSession().update("INTERFACE_LOG.updateStatus", params);
    	return true;
    }
	...
	public boolean deleteAll() throws Exception {
		return delete("INTERFACE_LOG.deleteAll", null) > 0?true:false;
	}
	 ...
	 * @throws Exception
	 */
	public boolean deleteByVo(InterfaceLog vo) throws Exception {
		if(vo == null) return false;
		int i = delete("INTERFACE_LOG.deleteByVO", vo);
    ...
    public boolean deleteByPk(String pkId) throws Exception {
		...
		delete("INTERFACE_LOG.deleteByPk", pkId);
		return true;
	}
}
