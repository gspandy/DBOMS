/**
 * com.tydic.dbs.dao.AppInfoDao.java
 */
...
public class AppInfoDao extends BaseDao {	
	...
	public Page queryForPage(Map params) throws Exception {
		return queryForPage("APP_INFO.selectByParams", params, null);
	}
	...
	public List selectAll() throws Exception {
		return queryForList("APP_INFO.selectAll", null);
	}
	...
	public List selectByParamMap(Map paramMap) throws Exception {
	    return queryForList("APP_INFO.selectByParams", paramMap);
	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List selectByVo(AppInfo vo) throws Exception {
	    if(vo == null) return null;
	    return queryForList("APP_INFO.selectByVO", vo);
	}
	 ...
	 * @throws Exception
     */
	public AppInfo selectByPk(String pkId) throws Exception {
    	if(StringUtils.isEmpty(pkId)) return null;
    	return (AppInfo)queryForObject("APP_INFO.selectByPk", pkId);
    }
	 ...
	 * @throws Exception
	 */
	public AppInfo insertByVo(AppInfo vo) throws Exception {
	    if(vo == null) return null;
	    return (AppInfo)insert("APP_INFO.insertByVo", vo);
    }
	 ...
	 * @throws Exception
	 */
	public AppInfo updateByVo(AppInfo vo) throws Exception {
		if(vo == null) return null;
		update("APP_INFO.updateByVO", vo);
		return vo;
	}
	 ...
	 * @throws Exception
	 */
	public AppInfo updateByVoNotNull(AppInfo vo) throws Exception {
		if(vo == null) return null;
		update("APP_INFO.updateByVoNotNull", vo);
		return vo;
	}
    ...
    public boolean updateStatus(Map params) throws Exception {
    	...
    	getSqlSession().update("APP_INFO.updateStatus", params);
    	return true;
    }
	...
	public boolean deleteAll() throws Exception {
		return delete("APP_INFO.deleteAll", null) > 0?true:false;
	}
	 ...
	 * @throws Exception
	 */
	public boolean deleteByVo(AppInfo vo) throws Exception {
		if(vo == null) return false;
		int i = delete("APP_INFO.deleteByVO", vo);
    ...
    public boolean deleteByPk(String pkId) throws Exception {
		...
		delete("APP_INFO.deleteByPk", pkId);
		return true;
	}
	public AppInfo selectBuPk(String appName) throws Exception {
    	if(StringUtils.isEmpty(appName)) return null;
    	return (AppInfo)queryForObject("APP_INFO.selectBuPk", appName);
    }
}
