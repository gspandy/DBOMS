/**
 * com.sunrise.accout.bo.ConsumListBo.java
 */
 ...
 *   	2. ...
 */
public class ConsumListBo implements ConsumListService {
	
	private ConsumListDao consumListDao;
	

    /**
	 * @param consumListDao the consumListDao to set
	 */
    ...
    public List getAll() throws Exception {
		return consumListDao.selectAll();
	}
     ...
     */
	@SuppressWarnings({ "rawtypes" })
    public List get(ConsumList vo) throws Exception{
		if(vo == null) return null;
        return consumListDao.selectByVo(vo);
	}
    ...
    public Page getPageByParamMap(Map params) throws Exception{
		...
		return consumListDao.queryForPage(params);
	}
     ...
     * @throws Exception
     */
	public ConsumList get(String pkId) throws Exception{
		if(StringUtils.isEmpty(pkId)) return null;
     	return consumListDao.selectByPk(pkId);
	}
     ...
     * @throws Exception
     */
    public ConsumList save(ConsumList vo) throws Exception{
    	if(vo == null) return null;		
		if(vo.getConsumId()!=null) {
			return consumListDao.updateByVo(vo);
		} else {
			return consumListDao.insertByVo(vo);
		}
    }
    ...
    public boolean delete(String pkId) throws Exception{
    	...
    	return consumListDao.deleteByPk(pkId);
    }
	...
	public boolean deleteLogical(List ids, String modifier) throws Exception{
    	...
    	return consumListDao.updateStatus(params);
	}
